...
import faker.data.Data
import faker.util.{SeqExtensions, ArrayExtensions, StringExtensions}
...
trait Base
  ...
  /**
    ...
    * See [[faker.data.LocaleData.get( )]] for details.
    */
  ...
  /**
    ...
    * See [[faker.data.LocaleData.getSeq( )]] for details.
    */
